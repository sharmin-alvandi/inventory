...
while !exit_app do
 ...
 case main_menu_option
  when "1"
    ...
    puts "1-Add a new product, 2-Show products, 3-Modify a Product "
    option = gets.chomp()
    case option
      when "1"
        # Add  a new product
      ...
      when "3"
        puts "3 Modify a product"
      end
    when "2"
      # warehouse manipulation
      puts "1-Add a new warehouse, 2-Show warehouses, 3-Modify a warehouse "
      option = gets.chomp()
      case option
      when "1"
        # Add a new warehouse
        ...
        while (continue == "Y") do
          ...
          while !valid_postalcode do
            ...
            if !Validation.validate_postal_code(w_location)
